...
temp = re.findall(r'\d+', os.path.basename(images[0]))
...
for i, fn in enumerate(kklistf):
    try:
        ...
        print("!! SKIPPED: %s (python imaging library couldn't open the image) !!" % fn)
        continue
