...
Here, the ensemble average is performed simultaneously over random interactions matrices
...
def run(
    ...
    comp_dist: str = "lognormal",  # distribution of the inital composition
    ...
    results = {
        ...
        "cluster_counts": np.bincount(counts).tolist(),
