...
"""
This script optimizes interaction matrices with respect to both phase count and the 
enrichment of compositions.

Run `./optimize_composition.py -h` to get information about the permissible parameters. 
...
from multicomp import FullChiIndividual, PartitioningEnvironment, get_optimization_model

# define the evolution model by composing classes for individual and environment
EvolutionModel = get_optimization_model(FullChiIndividual, PartitioningEnvironment)
